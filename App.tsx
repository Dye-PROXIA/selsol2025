...
const App: React.FC = () => {
  ...
  const handleCustomerChange = useCallback((key: string, value: string) => {
    setCustomer(prev => ({ ...prev, [key]: value }));
  }, []);

  const handleItemChange = useCallback((id: string, key: keyof Omit<LineItem, 'id'>, value: string | number) => {
